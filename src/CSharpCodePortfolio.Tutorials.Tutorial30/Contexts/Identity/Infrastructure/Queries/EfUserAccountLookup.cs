...
namespace CSharpCodePortfolio.Tutorials.Tutorial30.Contexts.Identity.Infrastructure.Queries;

/// <summary>
/// EF Core implementation of the user lookup query port.
/// </summary>
public sealed class EfUserAccountLookup(Tutorial30DbContext dbContext) : IUserAccountLookup
{
    /// <summary>
