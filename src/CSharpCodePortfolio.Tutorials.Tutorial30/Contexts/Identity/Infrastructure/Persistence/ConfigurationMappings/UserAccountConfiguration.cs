...
namespace CSharpCodePortfolio.Tutorials.Tutorial30.Contexts.Identity.Infrastructure.Persistence.ConfigurationMappings;

/// <summary>
/// Maps the DDD aggregate directly, using value converters for value objects.
/// </summary>
