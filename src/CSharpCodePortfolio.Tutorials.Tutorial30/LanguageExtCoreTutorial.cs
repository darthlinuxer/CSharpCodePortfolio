...
public sealed class LanguageExtCoreTutorial : ITutorial
{
    ...
    public async Task RunAsync(CancellationToken cancellationToken)
    {
        ...
        TutorialConsole.WriteExperiment(
            ...
            "Mantenha Name e Email obrigatórios; use Option<T> só para ausência válida, como PhoneNumber. Documento foi removido: modelagem PF/PJ é responsabilidade de outro bounded context.");
        TutorialConsole.WriteCodeSnippet(
        ...
        TutorialConsole.WriteExperiment(
            ...
            "Execute o mesmo caso de uso com email ausente, email presente e email duplicado.");
        TutorialConsole.WriteCodeSnippet(
    ...
    {
        var account =
            UserAccount.Create("Alan Turing", "alan@example.com", null);
